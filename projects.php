...
$project1_details = $content_data['project1_details'];
    ...
    <div data-animation="default" data-collapse="medium" data-duration="400" data-easing="ease" data-easing2="ease" role="banner" class="navbar">
        <div class="nav">
            <header class="section">
                ...
                <a href="about-me.php" class="button headerbuttunsel w-button"><span class="text-span headtextunsel">About Me</span></a>
                <a href="projects.php" class="button headerbuttsel w-button"><span class="text-span headtextsel">Projects</span></a>
            ...
            <details class="project">
                <summary>
                    <div class="project-thumbnail">
                        <img src="assets/images/chatbot.PNG" alt="Project 1 Preview" class="project-image">
                    </div>
                    <p class="project-title">Chatbot</p>
                </summary>
                <div class="project-details">
                    <p><?php echo $project1_details; ?></p>
                </div>
            </details>
